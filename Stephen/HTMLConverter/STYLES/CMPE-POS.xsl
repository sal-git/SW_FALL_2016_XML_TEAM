						...
						<ul style="list-style-type:none">
							...
							<li>
								<ul style="list-style-type:none">
									...
									<li>
										<ul style="list-style-type:none">
											<a href="XML/COURSES/phil-2326/phil-2326.xml"><li>PHIL 2326 Professional Ethics: Engineering</li></a>
										</ul>
									</li>
								</ul>
							</li>
								...
								<ul style="list-style-type:none">
									...
									<li>
										<ul style="list-style-type:none">
											...
											<li>
												<ul style="list-style-type:none">
													<a href="XML/COURSES/cmpe-1370/cmpe-1370.xml"><li>CSCI/CMPE 1370 Engineering Computer Science I (or CSCI/CMPE 1378 Honors)</li></a>
												</ul>
											</li>
										</ul>
									</li>
						...
						<ol>
							<li>
								...
								<xsl:for-each select="POS/Course">
									<ul style="list-style-type:none">
										<li>
											<xsl:if test="Divide[text()='Computer_Engineering_Core']">
							...
							<li>
								...
								<xsl:for-each select="POS/Course">
									<ul style="list-style-type:none">
										<li>
											<xsl:if test="Divide[text()='Computer_Engineering_Senior_Design']">
												<xsl:variable name="link"><xsl:value-of select="Prefix"/><xsl:text>-</xsl:text><xsl:value-of select="Number"/></xsl:variable>
												<a href="XML/COURSES/{$link}/{$link}.html">
													<xsl:value-of select="Prefix"/><xsl:text> </xsl:text><xsl:value-of select="Number"/><xsl:text> </xsl:text><xsl:value-of select="Name"/>
												</a>
							...
							<li>
								...
								<xsl:for-each select="POS/Course">
									<ul style="list-style-type:none">
										<li>
											<xsl:if test="Divide[text()='Computer_Engineering_Technical_Elective']">
												<xsl:variable name="link"><xsl:value-of select="Prefix"/><xsl:text>-</xsl:text><xsl:value-of select="Number"/></xsl:variable>
												<a href="XML/COURSES/{$link}/{$link}.html">
													<xsl:value-of select="Prefix"/><xsl:text> </xsl:text><xsl:value-of select="Number"/><xsl:text> </xsl:text><xsl:value-of select="Name"/>
												</a>
								...
								<ol type="a">
									<li>
										...
										<xsl:for-each select="POS/Course">
											<ul style="list-style-type:none">
												<li>
													<xsl:if test="Divide[text()='Computer_Engineering_Software_Concentration']">
														<xsl:variable name="link"><xsl:value-of select="Prefix"/><xsl:text>-</xsl:text><xsl:value-of select="Number"/></xsl:variable>
														<a href="XML/COURSES/{$link}/{$link}.html">
															<xsl:value-of select="Prefix"/><xsl:text> </xsl:text><xsl:value-of select="Number"/><xsl:text> </xsl:text><xsl:value-of select="Name"/>
														</a>
									...
									<li>
										...
										<xsl:for-each select="POS/Course">
											<ul style="list-style-type:none">
												<li>
													<xsl:if test="Divide[text()='Computer_Engineering_Hardware_Concentration']">
														<xsl:variable name="link"><xsl:value-of select="Prefix"/><xsl:text>-</xsl:text><xsl:value-of select="Number"/></xsl:variable>
														<a href="XML/COURSES/{$link}/{$link}.html">
															<xsl:value-of select="Prefix"/><xsl:text> </xsl:text><xsl:value-of select="Number"/><xsl:text> </xsl:text><xsl:value-of select="Name"/>
														</a>
					...
					<li>
						...
						<ol>
							<li>
								...
								<xsl:for-each select="POS/Course">
									<ul style="list-style-type:none">
										<a href="TEMP/phys-2425.html"><li>PHYS 2425 Physics for Scientist and Engineers I one-hour lab</li></a>
										<a href="TEMP/phys-2426.html"><li>PHYS 2426 Physics for Scientist and Engineers II one-hour lab </li></a>
									</ul>
								</xsl:for-each>
							</li>
							...
							<li>
								...
								<xsl:for-each select="POS/Course">
									<ul style="list-style-type:none">
										<a href="TEMP/chem-1311.html"><li>General Chemistry I</li></a>
										<a href="TEMP/chem-1307.html"><li>Chemistry for Engineers</li></a>
									</ul>
								</xsl:for-each>
							</li>
							...
							<li>
								...
								<xsl:for-each select="POS/Course">
									<ul style="list-style-type:none">
										<a href="TEMP/math-2413.html"><li>Calculus I (or MATH 2487 Honors) one-hour lecture</li></a>
										<a href="TEMP/math-2414.html"><li>Calculus II (or MATH 2488 Honors)</li></a>
										<a href="TEMP/math-2346.html"><li>Mathematics for Electrical and Computer Engineers</li></a>
										<a href="TEMP/math-2341.html"><li>Differential Equations</li></a>
										<a href="TEMP/math-2337.html"><li>Probability and Statistics</li></a>
									</ul>
								</xsl:for-each>
							</li>
						</ol>
